...
{
    public partial class RelConsultaHospitalar : DevExpress.XtraReports.UI.XtraReport
    {
        public RelConsultaHospitalar(List<ConsultaHospitalarViewModel> ConsultaHospitalar, DadosReportViewModel Dados)
        {
            InitializeComponent();
            ...
            objectDataSource1.DataSource = ConsultaHospitalar;
        }
