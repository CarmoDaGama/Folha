...
{
    public partial class RelGrafArtigosVendidos : DevExpress.XtraReports.UI.XtraReport
    {
        public RelGrafArtigosVendidos(List<RelMovArtigosViewModel> LtMovArtigo, string dtInicial, string dtFinal,string Armazem)
        {
            InitializeComponent();
